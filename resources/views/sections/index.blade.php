...
@section('content')
    ...
    <div class="mx-auto max-w-3xl">
        ...
        {{-- Page heading --}}
        <div class="mb-6">
            <h2 class="font-jakarta text-xl font-bold text-slate-900">New Section</h2>
            <p class="mt-1 text-sm text-slate-500">Fill in the details below to create a new section.</p>
        </div>

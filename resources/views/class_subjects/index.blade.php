...
@section('content')
    ...
    <div class="mx-auto max-w-3xl">
        ...
        {{-- Page heading --}}
        <div class="mb-6">
            <h2 class="font-jakarta text-xl font-bold text-slate-900">Assign subjects</h2>
            <p class="mt-1 text-sm text-slate-500">Fill in the details below to Assign subjects and more other</p>
        </div>


        <livewire:class-subjects />

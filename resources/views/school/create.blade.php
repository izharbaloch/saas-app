...
<body
            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="px-5 py-2 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="px-5 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800">
                        Log in
                    </a>
    ...
    <div class="flex items-center justify-center w-full">
        <main class="w-full max-w-5xl">
            ...
            <div class="bg-white dark:bg-[#111827] rounded-2xl shadow-xl p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name"
                                class="w-full rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-900 px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none"
